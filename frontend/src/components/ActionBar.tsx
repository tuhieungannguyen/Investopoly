  ...
  return (
    <section className={styles.actions}>
      {!gameStarted && isHost && (
        ...
        >
          <img src="/assets/ui/start.png" alt="" />
          Start
        </button>
      )}
      ...
      {gameStarted && (
        <>
          ...
          >
            <img src="/assets/ui/roll.png" alt="" />
            Roll
          </button>
          <button
          ...
          >
            <img src="/assets/ui/deposit.png" alt="" />
            Withdraw
          </button>
          <button
            className={styles.full}
